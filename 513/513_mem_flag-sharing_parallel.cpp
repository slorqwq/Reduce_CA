...
int recovery_p(int (*Error_vector)[n], int (*symdorme_result)[n], int (*syndrome_table)[n], int (*recovery_x)[n], int (*recovery_z)[n]);
...
//============================================================================================================================    
    ...
    cout << "%[[5,1,3]] parallel^2 with the last round is parallel, memeory threshold" << " ,loop=" << N-1 << " ,gamma, alpha, beta=" << Gamma << alpha << beta << endl << endl << endl;
...
*/
	...
	//  unflagged_v(Error_vector, probability, 0, 0,0 ); //g1,5,3,4
	 ...
	 //loading syndorme result to array	 
			...
			symdorme_result2[6] = Error_vector[0][15];  // g'1
			symdorme_result2[7] = Error_vector[0][16];  // g'5
			symdorme_result2[8] = Error_vector[0][17];  // g'3
			symdorme_result2[9] = Error_vector[0][18];  // g'4
/*
	cout<< "flag rise: " << endl;
 	cout<< "Error_vector X " << Error_vector[0][0]<<Error_vector[0][1] <<Error_vector[0][2] <<Error_vector[0][3] <<Error_vector[0][4]  << endl ;
	cout<< "Error_vector Z " << Error_vector[1][0]<<Error_vector[1][1] <<Error_vector[1][2] <<Error_vector[1][3] <<Error_vector[1][4]  << endl ;
